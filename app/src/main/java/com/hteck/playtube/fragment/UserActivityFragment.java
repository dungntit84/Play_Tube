...
import com.venustech.playtube.MyVideosView;
import com.venustech.playtube.UserChanelsView;
import com.venustech.playtube.UserDetails;
import com.venustech.playtube.UserPlaylistsView;
import com.venustech.playtube.UserVideosView;
import com.venustech.playtube.YoutubePlaylistVideosView;
import com.venustech.playtube.common.Constants;
import com.venustech.playtube.common.HttpGetFile;
import com.venustech.playtube.common.IEventHandler;
import com.venustech.playtube.common.Utils;
import com.venustech.playtube.common.Constants.ChannelActivityType;
import com.venustech.playtube.common.Constants.CustomField;
import com.venustech.playtube.common.Constants.LoadingVideosDataState;
import com.venustech.playtube.common.Constants.SortBy;
import com.venustech.playtube.common.Constants.VideoListType;
import com.venustech.playtube.common.Constants.YoutubePlaylistItemType;
import com.venustech.playtube.common.IEventHandler.ResultType;
import com.venustech.playtube.info.ChannelInfo;
import com.venustech.playtube.info.ChannelSectionInfo;
import com.venustech.playtube.info.KeyPairValue;
import com.venustech.playtube.info.PlaylistInfo;
import com.venustech.playtube.info.PlaylistItemInfo;
import com.venustech.playtube.info.VideoInfo;
import com.venustech.playtube.services.YoutubeHelper;
import com.venustech.playtube.views.YoutubePlaylistItemByPageAdapter;
...
public class UserActivityFragment extends Fragment implements
	...
	Vector<PlaylistItemInfo> _playlistItemViewInfos = new Vector<PlaylistItemInfo>();
	Vector<PlaylistItemInfo> _playlistItemViewInfosLoading = new Vector<PlaylistItemInfo>();
	Vector<ChannelSectionInfo> _activityListAll = new Vector<ChannelSectionInfo>();
	Vector<ChannelSectionInfo> _activityListLoading = new Vector<ChannelSectionInfo>();
	...
	public static UserHomeView newInstance(ChannelInfo channelInfo) {
		UserHomeView channelVideosTab = new UserHomeView();
	...
	public View onCreateView(LayoutInflater inflater, ViewGroup container,
		...
		if (MainActivity.getInstance().isAppTerminated()) {
	...
	private void loadData() {
		...
		String url = String.format(
				MainContext.getDevKeyInfo().getSectionsOfChannelApiUrl,
				_channelInfo.id);
		Utils.download(url, downloadCompletedIdsOnly);
	}

	private IEventHandler downloadCompletedIdsOnly = new IEventHandler() {
